...
const registerUser = async (req, res) => {
  ...
  console.log("Original Password (Registration):", password); // Log original password
...
const loginUser = async (req, res) => {
  ...
  console.log("Original Password (Login):", password); // Log original password
  ...
  try {
    ...
    console.log("Stored Hash Password (raw):", user.password);

    // Compare the password using async method with the `matchPassword` method
    const isMatch = await user.matchPassword(password);
    console.log("Password comparison result (async):", isMatch);
